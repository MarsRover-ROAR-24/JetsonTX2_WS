...
if("TRUE" STREQUAL "TRUE")
  set(localization_SOURCE_PREFIX /home/nvidia/roar_ws/src/JetsonTX2_WS/localization)
  set(localization_DEVEL_PREFIX /home/nvidia/roar_ws/src/JetsonTX2_WS/build/devel)
  ...
  set(localization_INSTALL_PREFIX /usr/local)
...
if(NOT "/home/nvidia/roar_ws/src/JetsonTX2_WS/localization/include " STREQUAL " ")
  set(localization_INCLUDE_DIRS "")
  set(_include_dirs "/home/nvidia/roar_ws/src/JetsonTX2_WS/localization/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'belal <ahmedbelal.asurt@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'localization' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/roar_ws/src/JetsonTX2_WS/localization/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/nvidia/roar_ws/src/JetsonTX2_WS/build/devel/lib;/home/nvidia/roar_ws/devel/lib;/opt/ros/noetic/lib)
...
set(depends "roscpp;rospy;std_msgs;roar_msgs;geometry_msgs;message_runtime;tf2;tf2_ros")
